...
class TestMoneroPaymentService:
    ...
    def test_get_wallet_parses_host_without_scheme(self, mock_settings):
        """Test _get_wallet parses host without scheme."""
        mock_settings.monero_rpc_url = "localhost:18083"
